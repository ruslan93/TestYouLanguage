...
-(void)initView:(CGRect)frame{
    ...
    [self setTotalBall:100];
    [self setResultBall:0];
}
...
- (void)setTotalBall:(NSInteger)totalBall{
    self.progressLayer.totalBall = totalBall;
}

- (void)setResultBall:(NSInteger)resultBall{
    self.progressLayer.resultBall = resultBall;
}
